            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Modifier livre</h4>
                    </div>
                    <div class="card-body">
                        <form  method="post" action="/modifier/traitement/" class="row g-3">
                          @csrf
                          <input type="text" name="id" style="display: none;"  value="{{$livres->id}}">
                            ...
                            <div class="col-12">
                                ...
                                <input type="date" class="form-control" id="publicationDate" placeholder="jj/mm/aaaa" name="date_de_publication"  value="{{$livres->date_de_publication}}">
                            </div>
                            <div class="col-md-6">
                                <label for="pageCount" class="form-label">Nombre de pages</label>
                                <input type="number" class="form-control" id="pageCount" required name="nombre_de_pages" value="{{$livres->nombre_de_pages}}">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-primary">Mis à jour du livre</button>
                            </div>
                        </form>
                    </div>
                </div>
